...
const ImportedMovieCard: React.FC<{ movie: Movie }> = ({ movie }) => {
  ...
  return (
    <div className="container max-w-screen-xl mx-auto py-8 px-4 sm:px-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-3xl font-bold">Movie Importer</h1>
          <p className="text-lg text-muted-foreground">Import your movie collection from CSV files</p>
        </div>
            ...
            <TabsContent value="imported" className="animate-fade-in">
              {importedMovies.length > 0 ? (
                  ...
                  {viewMode === 'grid' ? (
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                      {importedMovies.map((movie) => (
                        <ImportedMovieCard key={movie.id} movie={movie} />
                      ))}
                    </div>
                  ) : (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No movies imported yet</h3>
                  <p className="text-muted-foreground max-w-md mb-6">
                    Import a CSV file to add movies to your collection. We support various formats including Letterboxd, IMDb, and more.
                  </p>
